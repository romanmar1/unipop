...
public class QueryBuilder implements Cloneable{
        ...
        protected Object build() {
            ...
            for(Composite child : getChildren()) {
                if (child.getOp() == Op.query) {
                    ...
                    filterBuilder = (FilterBuilder) child.build();
                }
            }
    ...
    public class BoolComposite extends Composite {
        ...
        @Override
        protected Object build() {
            Iterable<FilterBuilder> mustFilters = new ArrayList<>();
            Iterable<FilterBuilder> mustNotFilters = new ArrayList<>();
            Iterable<FilterBuilder> shouldFilters = new ArrayList<>();

            for(Composite child : getChildren()) {
                switch (child.getOp()) {
                    case must:
                        mustFilters = (Iterable<FilterBuilder>)child.build();
                        break;

                    case mustNot:
                        mustNotFilters = (Iterable<FilterBuilder>)child.build();
                        break;

                    case should:
                        shouldFilters = (Iterable<FilterBuilder>)child.build();
                        break;
                }
            }
    ...
    public abstract class FiltersComposite extends Composite {
        ...
        protected Object build() {
            ...
            for(Composite child : getChildren()) {
                filters.add((FilterBuilder)child.build());
            }
            return filters;
        }
        //endregion
    ...
    public class TypeComposite extends Composite {
        ...
        @Override
        protected Object build() {
            return FilterBuilders.typeFilter(this.value);
        }
        //endregion
    ...
    public class ExistsComposite extends Composite {
        ...
        @Override
        protected Object build() {
            return FilterBuilders.existsFilter(this.value);
        }
        //endregion
